...
// Velocity Control Specific Constants: (TODO figure out a better place for these)
namespace velocity_control::constants {
    constexpr std::size_t num_actions = 2 *  go2::constants::num_joints;
 ...
 */
class VelocityControlPolicy : public rclcpp::Node {
    public:
        /**
         * @brief Construct a new Policy Interface object
         */
        VelocityControlPolicy(
        ...
        VelocityControlPolicy(const VelocityControlPolicy&) = delete;
        VelocityControlPolicy& operator=(const VelocityControlPolicy&) = delete;
        VelocityControlPolicy(VelocityControlPolicy&&) = delete;
        VelocityControlPolicy& operator=(VelocityControlPolicy&&) = delete;
    ...
    private:
        ...
        // Velocity Control Specific Settings:
        const velocity_control::constants::ActionVector<float> default_setpoints = 
            Eigen::Map<const velocity_control::constants::ActionVector<float>>(velocity_control::constants::default_setpoints.data());
};