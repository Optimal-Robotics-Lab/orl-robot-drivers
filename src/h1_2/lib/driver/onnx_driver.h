...
/**
 * @class ONNXDriver
 * @brief A class to control the Unitree's H1-2 robot using a Policy loaded from an ONNX file.
 */
class ONNXDriver : public rclcpp::Node {
    public:
         ...
         * @return absl::Status OkStatus on success, or an error if the thread cannot be joined.
         */
        absl::Status set_control_mode(h1_2::constants::HighLevelControlMode mode);

        /**
         * @brief Gets the current control mode.
         * @return HighLevelControlMode The current control mode.
         */
        const h1_2::constants::HighLevelControlMode get_control_mode();
    ...
    private:
        ...
        /**
         * @brief Transforms the Policy output to a H1-2 Command.
         * @return H1_2_Command Motor command.
         */
        H1_2_Command policy_command();
        ...
        h1_2::constants::HighLevelControlMode control_mode = h1_2::constants::HighLevelControlMode::DAMPING;
        int control_rate_us;
        const float action_scale = 0.5f;
        float master_gain = 0.0f;
        const h1_2::constants::MotorVector<float> default_position = Eigen::Map<const h1_2::constants::MotorVector<float>>(h1_2::constants::default_position.data());
        static constexpr std::array<float, h1_2::constants::num_joints> kp = h1_2::constants::default_kp;
        static constexpr std::array<float, h1_2::constants::num_joints> kd = h1_2::constants::default_kd;
